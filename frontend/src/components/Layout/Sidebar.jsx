...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/content-filters/prompt-shield',      icon: ShieldCheck,   label: 'Prompt Shield',         sub: 'Jailbreak + document attacks' },
      ...
      { to: '/content-filters/groundedness',       icon: CheckCircle,   label: 'Groundedness',          sub: 'Output hallucination' },
